;;; nftables-mode.el --- Major mode for editing Linux nftables files -*- lexical-binding: t -*-

;; Author: Trent Buck
;; Maintainer: N/A
;; Version: 0.1
;; Package-Requires: ((emacs "24.3"))
;; Homepage: https://github.com/mnewt/nftables-mode
;; Keywords: comm, files, languages, unix
...
;;
;; This mode was created by Trent W. Buck.  I uploaded his great work here and
;; slapped on some package headers in the hope that he wouldn't mind and maybe
;; someone else will find it useful.
;;
;; See https://debbugs.gnu.org/cgi/bugreport.cgi?bug=36759.
...
(defun nftables-indent-line ()
  "Indent the line in `nftables-mode'."
  (let (old-point)
    (save-excursion
      (back-to-indentation)
